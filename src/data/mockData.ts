...
// Assicurati che questo percorso e il file esistano se lo usi:
import { RecipeHeaderData as ImportedRecipeHeaderData } from '../components/RecipeDetailHeader/recipeDetailHeader.types';

// Importa il tipo Route da Next.js
import type { Route } from 'next'; // Aggiunta questa importazione
...
export const mockRecipeCardDataArray: RecipeCardData[] = [
  {
    ...
    difficulty: 'Easy',
    calories: '79 kcal',
    href: '/recipes/vegetarian-polpette' as Route, // Aggiunto 'as Route'
  },
  {
    id: 'rc2',
    ...
    difficulty: 'Medium',
    calories: '320 kcal',
    href: '/recipes/quinoa-bowl' as Route, // Aggiunto 'as Route'
  },
  {
    id: 'rc3',
    ...
    difficulty: 'Hard',
    calories: '410 kcal',
    href: '/recipes/thai-curry-soup' as Route, // Aggiunto 'as Route'
  },
  {
    id: 'rc4',
    ...
    time: '45 min',
    difficulty: 'Easy',
    href: '/recipes/stuffed-mushrooms' as Route, // Aggiunto 'as Route'
  },
  {
    id: 'rc5',
    ...
    time: '35 min',
    difficulty: 'Easy',
    href: '/recipes/vegetable-fritters' as Route, // Aggiunto 'as Route'
  },
];


// --- Mock Data for Full Page Example (used in showcase) ---
// Se `ImportedRecipeHeaderData` non è definito perché il componente RecipeDetailHeader non esiste,
// commenta o rimuovi le seguenti definizioni e il loro uso.
...
export const mockRecipeHeaderData: RecipeHeaderData = {
  ...
  breadcrumbs: [
    { name: 'Home', href: '/' }, // href: string, ma potrebbe essere Type asserito se Breadcrumb.href fosse Route
    { name: 'Recipes', href: '/recipes' },
    { name: 'Appetizers', href: '/recipes/appetizers' },
  ] as RecipeHeaderData['breadcrumbs'], // Aggiunto Type Assertion per l'array breadcrumbs
  title: 'Vegetarian Polpette with Yogurt Dip',
  rating: 4.5,
  reviewCount: 124,
  description:
